...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name="이메일"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("transaction_amount", models.DecimalField(decimal_places=2, max_digits=18, verbose_name="거래 금액")),
                (
                    "amount_after_transaction",
                    models.DecimalField(decimal_places=2, max_digits=18, verbose_name="거래 후 잔액"),
                ),
                ("account_factor_history", models.CharField(max_length=255, verbose_name="계좌 인자 내역")),
                (
                    "deposit_and_withdrawal_type",
                    models.CharField(
                        choices=[("DEPOSIT", "입금"), ("WITHDRAW", "출금")], max_length=8, verbose_name="입출금 타입"
                    ),
                ),
                (
                    "transaction_type",
                ...
                ("transaction_timestamp", models.DateTimeField(auto_now_add=True, verbose_name="거래 일시")),
